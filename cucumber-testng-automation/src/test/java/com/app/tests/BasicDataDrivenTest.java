...
import com.app.pages.GasMillageCalculatorPage;
...
public class BasicDataDrivenTest {
	...
	Workbook workbook;
	Sheet worksheet;
	GasMillageCalculatorPage page = new GasMillageCalculatorPage();
	...
	public void dataDrivenMileageCalculatorTest() {
		...
		if(result[0].equals(format.format(calculationResult))) {
			System.out.println("Pass Calculation Result");
		}else {
			System.out.println("Fail Calculation Result");
		}
